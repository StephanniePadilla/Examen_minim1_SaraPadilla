...
public class App {
    ...
    public static final String BASE_URI = "http://localhost:8080/Examen_minim1_SaraPadilla/";
    ...
    public static HttpServer startServer() {
        ...
        final ResourceConfig rc = new ResourceConfig().packages("main.java.Controller");
